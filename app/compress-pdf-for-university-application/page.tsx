...
export const metadata = {
  title: "Compress PDF for University Application | Free Online Tool",
  description:
    "Compress PDF files for University Application. Reduce size to meet upload limits. Free and secure.",
};
    ...
    <main className="min-h-screen bg-white px-4 py-14">
      <div className="mx-auto max-w-3xl text-gray-800">
        ...
        <p className="mt-4 text-lg text-gray-600 text-center">
          Reduce your PDF file size for university admissions and online application portals.
        </p>
