...
export default function CompressPdfTo1MbPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What does “compress to 500kb” mean?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It means reducing the PDF file size to 500kb or smaller so it meets strict upload limits."
      }
    },
    {
      "@type": "Question",
      "name": "Will compressing to 500kb reduce quality?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "If 500kb still fails, what should I do?",
      "acceptedAnswer": {
        "@type": "Answer",
