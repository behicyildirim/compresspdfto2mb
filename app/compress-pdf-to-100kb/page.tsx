...
export const metadata = {
  ...
  description:
    "Compress PDF to 100kb instantly online. Free, secure and no registration required.",
};
      ...
      <div className="mx-auto max-w-3xl text-gray-800">
        ...
        <div className="mt-10 space-y-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-semibold mt-10">
            Why reduce PDF to 100kb?
          </h2>
          <p>
            Many email services, online portals, and job applications require documents under 100kb.
