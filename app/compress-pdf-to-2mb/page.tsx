...
export const metadata = {
  title: "Compress PDF to 2MB Online Free | CompressPDFto2MB",
  description:
    "Compress PDF to 2MB online in seconds. Free, secure, and great as a safe starting target for uploads.",
};
  ...
  return (
    <main className="min-h-screen bg-white px-4 py-14">
      <div className="mx-auto max-w-3xl text-gray-800">
        <h1 className="text-4xl font-bold text-center">Compress PDF to 2MB Online Free</h1>

        <p className="mt-4 text-lg text-gray-600 text-center">
          Not sure about the upload limit? 2MB is a great safe starting target for many portals.
        </p>
        ...
        <div className="mt-10 space-y-8 leading-relaxed">
          <section>
            <h2 className="text-2xl font-semibold">Fastest fix for upload limits</h2>
            <p className="mt-2">
              Start by compressing to 2MB. If the portal still rejects the file due to strict limits,
              you may need to{" "}
              <Link
          ...
          <section>
            <h2 className="text-2xl font-semibold">Why 2MB is a good default</h2>
