    ...
    <main className="min-h-screen bg-white px-4 py-14">
      <div className="mx-auto max-w-3xl text-gray-800">
        ...
        <h1 className="text-4xl font-bold text-center">
          Compress PDF to 3MB Online Free
        </h1>

        <p className="mt-4 text-lg text-gray-600 text-center">
          Reduce your PDF file size to 3MB or smaller in seconds.
        </p>
        ...
        <div className="mt-10 space-y-6 leading-relaxed">
          ...
          <p>
            Many email services, online portals, and job applications require documents under 3MB.
